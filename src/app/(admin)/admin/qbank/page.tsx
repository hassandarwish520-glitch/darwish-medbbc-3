...
export default async function AdminQBank() {
  ...
  const { data } = await admin
    .from("questions")
    .select("id, stem, difficulty, ai_generated, tags, image_path, image_caption, video_url, created_at")
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-slate-400 text-sm">Manage exam questions, medical images, AI generation, and JSON import.</p>
